...
const UpdateCustomer = ({ customerId }) => {
  ...
  useEffect(() => {
    const fetchCustomer = async () => {
      try {
        const response = await axios.get(`https://user-bank-info-management.vercel.app/api/updateuserdata/${state.currentUserId}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(`https://user-bank-info-management.vercel.app/api/updateuserdata/${state.currentUserId}`, customerData);
